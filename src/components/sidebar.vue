	...
	<div class="sidebar absolute square active-font-primary" ref="sidebar">
		<div class="sidebar-menu">
          ...
          active: isActive('/variables'),
			...
			<div class="sidebar-group has-icon" ref="form">
			...
			<div class="sidebar-group has-icon" ref="components">
			...
			<div class="sidebar-group has-icon" ref="layout">
			...
			<div class="sidebar-group has-icon" ref="utilities">
